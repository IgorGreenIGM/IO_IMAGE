...
namespace PixelsManager
{
    ...
    */
    ...
    uint8_t *blur_part(const uint8_t *rgb_in, int rgb_len, int s_width, int s_height, int x_start, int y_start, int x_end, int y_end, int side_neigbours);
    uint8_t *blur_part(const uint8_t *rgb_in, int rgb_len, int s_width, int s_height, const uint8_t *bin_in, int side_neigbours);

    uint8_t *edge_detection(const uint8_t *rgb_in, int rgb_len, int s_width, int s_height, int iter_number = 1);

    uint8_t *downscale_buffer(const uint8_t *rgb_in, int rgb_len, int width_in, int height_in, float scale, int &width_out, int &height_out);
